        ...
        try {
            ...
            for (Element hero : heroes) {
                ...
                if (heroWinRateToDouble > 55.0)
                    this.heroesTier.add(new SimpleEntry<>(heroName, new SimpleEntry<>(se, new SimpleEntry<>("S", heroWinRateToDouble))));
                else if (heroWinRateToDouble > 53.0)
                    this.heroesTier.add(new SimpleEntry<>(heroName, new SimpleEntry<>(se, new SimpleEntry<>("A", heroWinRateToDouble))));
                else if (heroWinRateToDouble > 51.0)
                    this.heroesTier.add(new SimpleEntry<>(heroName, new SimpleEntry<>(se, new SimpleEntry<>("B", heroWinRateToDouble))));
                else if (heroWinRateToDouble > 49.0)
                    this.heroesTier.add(new SimpleEntry<>(heroName, new SimpleEntry<>(se, new SimpleEntry<>("C", heroWinRateToDouble))));
                else if (heroWinRateToDouble > 47.0)
                    this.heroesTier.add(new SimpleEntry<>(heroName, new SimpleEntry<>(se, new SimpleEntry<>("D", heroWinRateToDouble))));
                else if (heroWinRateToDouble > 45.0)
                    this.heroesTier.add(new SimpleEntry<>(heroName, new SimpleEntry<>(se, new SimpleEntry<>("E", heroWinRateToDouble))));
                else
                    this.heroesTier.add(new SimpleEntry<>(heroName, new SimpleEntry<>(se, new SimpleEntry<>("F", heroWinRateToDouble))));
            }
        } catch (IOException e) {
